	...
	return new Promise((resolve, rejecet) => {
        ...
        axios.request({
            ...
            const result = {
				...
				mirror_1: ch('body > div.welcome.section > div > div:nth-child(2) > div.col.s12.l8 > a:nth-child(3)').attr('href'),
				mirror_2: ch('body > div.welcome.section > div > div:nth-child(2) > div.col.s12.l8 > a:nth-child(5)').attr('href'),
                HD: ch('body > div.welcome.section > div > div:nth-child(2) > div.col.s12.l8 > a:nth-child(7)').attr('href'),
				video_WM: ch('body > div.welcome.section > div > div:nth-child(2) > div.col.s12.l8 > a:nth-child(9)').attr('href')
            }
        resolve(result)
		})
	  }
...
module.exports = { tiktokMp4, tiktokMp3 };